...
export const FEATURE_LOG_ENTRIES: FeatureLogEntry[] = [
  {
    ...
    bullets: {
      de: [
        ...
        "Der Gear-Verlauf nutzt jetzt die komplette verfügbare Historie und bietet feste Zeitfilter wie Alle, 2J, 1J, 6M und 3M.",
      ...
      en: [
        ...
        "The gear trend now uses the full available history and adds fixed time filters such as All, 2Y, 1Y, 6M, and 3M.",
