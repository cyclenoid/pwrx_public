...
export const FEATURE_LOG_ENTRIES: FeatureLogEntry[] = [
  {
    ...
    summary: {
      de: "Leistung @150 bpm nutzt jetzt gekoppelte Watt-/Puls-Streams, HF-Zonen koennen LTHR oder HF-Reserve verwenden, und PMC beruecksichtigt Outdoor-Fahrten ohne Powermeter sowie Laeufe per HF-TSS.",
      en: "Power @150 bpm now uses paired power/heart-rate streams, HR zones can use LTHR or heart-rate reserve, and PMC accounts for outdoor rides without power meters plus runs via HR-TSS.",
    },
    bullets: {
      de: [
  ...
  },
  {
    ...
    bullets: {
      de: [
        ...
        "Jede Karte verlinkt direkt in die jeweilige Aktivität und hebt Distanz, Höhenmeter, Pace und Dauer stärker hervor.",
        "Zusätzliche Gelände-Badges und eine farblich gewichtete Effizienzkennzahl machen schnelle Einordnung einfacher.",
      ...
      en: [
        ...
        "Each card links directly to the matching activity and gives more visual weight to distance, elevation, pace, and duration.",
        "Additional terrain badges and a color-weighted efficiency metric make quick interpretation easier.",
  ...
  },
  {
    ...
    bullets: {
      de: [
        ...
        "Der Gear-Verlauf nutzt jetzt die komplette verfügbare Historie, füllt inaktive Monate bis heute auf und bietet feste Zeitfilter wie Alle, 2J, 1J, 6M und 3M.",
        "Die Zeitachse markiert Jahreswechsel klarer und zeigt im Header zusätzlich den aktiven Datenbereich und den aktuell dargestellten Zeitraum.",
      ...
      en: [
        ...
        "The gear trend now uses the full available history, fills inactive months through today, and adds fixed time filters such as All, 2Y, 1Y, 6M, and 3M.",
        "The time axis highlights year boundaries more clearly and the header now shows both the active data range and the currently displayed window.",
